...
--- deps/v8/src/base/platform/platform-freebsd.cc.orig	2016-01-21 01:08:19.000000000 +0000
+++ deps/v8/src/base/platform/platform-freebsd.cc
@@ -74,10 +74,10 @@ static unsigned StringToLong(char* buffe
...
+  if (fd < 0) return address_result;
   while (true) {
     char addr_buffer[11];
     addr_buffer[0] = '0';
@@ -108,10 +108,10 @@ std::vector<OS::SharedLibraryAddress> OS
