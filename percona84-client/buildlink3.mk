...
BUILDLINK_API_DEPENDS.percona-client+=	percona-client>=8.4<8.5
BUILDLINK_ABI_DEPENDS.percona-client+=	percona-client>=8.4<8.5
BUILDLINK_PKGSRCDIR.percona-client?=	../../joyent/percona84-client
