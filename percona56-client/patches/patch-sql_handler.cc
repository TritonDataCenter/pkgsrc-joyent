...
--- sql/handler.cc.orig	2013-10-07 10:25:25.000000000 +0000
+++ sql/handler.cc
@@ -5924,7 +5924,7 @@ handler::multi_range_read_init(RANGE_SEQ
...
+                               my_test(mrr_cur_range.range_flag & EQ_RANGE),
       ...
       if (result != HA_ERR_END_OF_FILE)
         break;
@@ -6077,7 +6077,7 @@ int DsMrr_impl::dsmrr_init(handler *h_ar
...
@@ -6368,7 +6368,7 @@ int DsMrr_impl::dsmrr_next(char **range_
     if (is_mrr_assoc)
...
+    rowids_buf_cur += h->ref_length + sizeof(void*) * my_test(is_mrr_assoc);
 	...
 	h2->mrr_funcs.skip_record(h2->mrr_iter, (char *) cur_range_info, rowid))
       continue;
@@ -6590,7 +6590,7 @@ bool DsMrr_impl::get_disk_sweep_mrr_cost
